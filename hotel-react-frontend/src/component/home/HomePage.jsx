        ...
        <div className="home">
            <section>
                <header className="header-banner">
                    <img src="./images/Hotel-bg-2.png" alt="Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>Welcome to <span className="phegon-color">The Grandvista Hotel</span></h1> <br/>
            ...
            <h2 className="home-services">Services at <span className="phegon-color">The Grandvista Hotel</span></h2>

            {/* SERVICES SECTION */}
            <section className="service-section"><div className="service-card">
                <img src="./images/air-conditioner.png" alt="Air Conditioning" />
                ...
                <div className="service-card">
                    <img src="./images/bar.png" alt="Mini Bar" />
                    <div className="service-details">
                ...
                <div className="service-card">
                    <img src="./images/parking-car.png" alt="Parking" />
                    <div className="service-details">
